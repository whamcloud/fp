...
describe("the fp module", () => {
  describe("has a map method", () => {
    ...
    it("should exist on fp", () => {
      const result: ((x: number) => number) => (x: number[]) => number[] = fp.map;
  ...
  describe("has a filter method", () => {
    it("should exist on fp", () => {
      const result: (fn: (a: number) => boolean) => (a: number[]) => number[] = fp.filter;
      expect(result).toEqual(jasmine.any(Function));
    });
  ...
  describe("has a reduce method", () => {
    it("should exist on fp", () => {
      const result: (a: number) => ((a: number, b: number) => number) => (x: number[]) => number = fp.reduce;
      expect(result).toEqual(jasmine.any(Function));
    });
  ...
  describe("has a find method", () => {
    it("should exist on fp", () => {
      const result: ((x: number) => boolean) => (a: number[]) => Maybe<number> = fp.find;
      expect(result).toEqual(jasmine.any(Function));
    });
  ...
  describe("has a pluck method", () => {
    it("should exist on fp", () => {
      const result: (key: string | number) => (a: { foo: "string" }[]) => string[] = fp.pluck;
      expect(result).toEqual(jasmine.any(Function));
    });
  ...
  describe("has an always method", () => {
    it("should exist on fp", () => {
      const result: (x: string) => (a: number, b: boolean, c: string) => string = fp.always;
      expect(result).toEqual(jasmine.any(Function));
    });
  ...
  describe("has a compose method", () => {
    it("should exist on fp", () => {
      const result: (fn: Fn1<string, number>) => Fn1<string, number> = fp.compose;
      expect(result).toEqual(jasmine.any(Function));
    });
    ...
    it("should compose fns", () => {
      const add1 = (x: number) => x + 1;
      const mult2 = (x: number) => x * 2;
      const result: number = fp.compose(
        mult2,
        add1
      )(3);
      expect(result).toEqual(8);
  ...
  describe("has a difference method", () => {
    it("should exist on fp", () => {
      const result: (xs: number[]) => (xs: number[]) => number[] = fp.difference;
      expect(result).toEqual(jasmine.any(Function));
    });
  ...
  describe("has a differenceBy method", () => {
    ...
    beforeEach(() => {
      ...
      b = [{ id: 1, name: "foo" }, { id: 2, name: "bar" }, { id: 3, name: "baz" }, { id: 4, name: "bap" }];
    });
  ...
  describe("has a intersectionBy method", () => {
    ...
    it("should exist on fp", () => {
      const result: (a: ({ id: number }) => number) => (a: idArrayT) => (a: idArrayT) => idArrayT = fp.intersectionBy;
      expect(result).toEqual(jasmine.any(Function));
    });
    ...
    describe("has a set method", () => {
      ...
      describe("mapped", () => {
        ...
        it("should map an array", () => {
          ...
          const result: string[] = fp.view(lens)([{ name: "foo" }, { name: "bar" }]);
      ...
      describe("lensProp", () => {
        ...
        it("should work with over", () => {
          const result: dataT = fp.over(fp.lensProp("name"))(x => x + "ard")(data);
          expect(result).toEqual({
            name: "Richie Richard",
            addresses: [
              {
  ...
  describe("has a cond method", () => {
    ...
    it("should exist on fp", () => {
      const result: (...conditions: [Fn1<number, boolean>, Fn1<number, string>][]) => (x: number) => string = fp.cond;
      expect(result).toEqual(jasmine.any(Function));
    });
  ...
  describe("has an invoke method", () => {
    ...
    it("should exist on fp", () => {
      const result: ((...rest: mixed) => number) => (x: string) => number = fp.invoke;
      expect(result).toEqual(jasmine.any(Function));
    });
    it("should invoke the function with an array of items", () => {
      ...
      fp.invoke(spy)(items);
      expect(spy).toHaveBeenCalledWith("some", "array", "of", "items", 7, {
        key: "val"
      });
  ...
  describe("has an and method", () => {
    ...
    beforeEach(() => {
      isFooAnd3Chars = fp.and([fp.eq("foo"), fp.eqFn(fp.identity)(fp.view(fp.lensProp("length")))(3)]);
    });
    it("should exist on fp", () => {
  ...
  describe("has an invokeMethod method", () => {
    ...
    it("should return a function that is bound and invoke that function", () => {
      const indexOfB: (str: string) => number = (fp.invokeMethod("indexOf")(["b"]): (str: string) => number);
  ...
  describe("has an either method", () => {
    ...
    describe("chaining", () => {
      let spy1, spy2, spy1Error, spy2Error, chain: (x: "bar") => "bar" | Error, chainError;
      beforeEach(() => {
        spy1 = (jasmine.createSpy("spy1").and.callFake(fp.identity): (x: "bar") => "bar");
        spy2 = (jasmine.createSpy("spy2").and.callFake(fp.identity): (x: "bar" | Error) => "bar");
        spy1Error = (jasmine.createSpy("spy1").and.callFake(fp.identity): (x: Error) => Error);
        spy2Error = (jasmine.createSpy("spy2").and.callFake(fp.identity): (x: Error) => Error);
    ...
    describe("non-error handling", () => {
      ...
      beforeEach(() => {
        spy = (jasmine.createSpy("spy").and.callFake(fp.identity): (x: "foo") => "foo");
  ...
  describe("has an mapFn method", () => {
    ...
    beforeEach(() => {
      args = ["a", 1, false];
      spy1 = (jasmine.createSpy("spy1").and.returnValue(1): (a: "a", b: 1, c: false) => 1);
      spy2 = (jasmine.createSpy("spy2").and.returnValue(2): (a: "a", b: 1, c: false) => 2);
      spy3 = (jasmine.createSpy("spy3").and.returnValue(3): (a: "a", b: 1, c: false) => 3);
    ...
    it("should invoke spy1 with (a, 1, false).", () => {
      expect(spy1).toHaveBeenCalledWith("a", 1, false);
      expect(spy1).toHaveBeenCalledTimes(1);
    });
    it("should invoke spy2 with (a, 1, false).", () => {
      expect(spy2).toHaveBeenCalledWith("a", 1, false);
      expect(spy2).toHaveBeenCalledTimes(1);
    });
    it("should invoke spy3 with (a, 1, false).", () => {
      expect(spy3).toHaveBeenCalledWith("a", 1, false);
  ...
  describe("zipBy", () => {
    ...
    describe("matching functions with single args", () => {
      beforeEach(() => {
        spy1 = (jasmine.createSpy("spy1").and.callFake(fp.identity): (x: string) => string);
        spy2 = (jasmine.createSpy("spy2").and.callFake(fp.identity): (x: string) => string);
        spy3 = (jasmine.createSpy("spy3").and.callFake(fp.identity): (x: string) => string);
        result = fp.zipBy((a: (x: string) => string, b: string) => a(b))([spy1, spy2, spy3])(["dee", "doo", "da"]);
      });
      it("should exist on fp", () => {
      ...
      describe("with fewer left than right", () => {
        it("should return the result of the first two", () => {
          const result: Array<string> = fp.zipBy((a: (x: string) => string, b: string) => a(b))([spy1, spy2])([
            "dee",
            "doo",
            "da"
          ]);
      ...
      describe("with fewer right than left", () => {
        it("should return the result of the first two", () => {
          const result: Array<string> = fp.zipBy((a: (x: string) => string, b: string) => a(b))([spy1, spy2, spy3])([
            "dee",
            "doo"
          ]);
          expect(result).toEqual(["dee", "doo"]);
    ...
    describe("concatenating strings", () => {
      it("should concat the results into a single array", () => {
        const result: Array<string> = fp.zipBy((a, b) => a + b)(["cat", "space", "thunder"])([
          "amaran",
          " balls",
          " storm"
        ]);
  ...
  describe("match", () => {
    ...
    describe("with 2 entries", () => {
      it('should return "foo"', () => {
        const r: "foo" = fp.match([class1RString, class2RString])(new ClassType1());
        expect(r).toEqual("foo");
      });
      it("should return an instance of ClassType1", () => {
        const r: boolean = fp.match([class1RClass1, class2RString])(new ClassType1()) instanceof ClassType1;
        expect(r).toBe(true);
      });
      it('should return "bar"', () => {
        const r: "bar" = fp.match([class1RString, class2RString])(new ClassType2());
        expect(r).toEqual("bar");
      });
      it("should return an instance of ClassType2", () => {
        const r: boolean = fp.match([class1RString, class2RClass2])(new ClassType2()) instanceof ClassType2;
        expect(r).toBe(true);
      });
    ...
    describe("with 3 entries", () => {
      it('should return "foo"', () => {
        const r: "foo" = fp.match([class1RString, class2RString, class3RString])(new ClassType1());
        expect(r).toEqual("foo");
      });
      it('should return "bar"', () => {
        const r: "bar" = fp.match([class1RString, class2RString, class3RString])(new ClassType2());
        expect(r).toEqual("bar");
      });
      it('should return "baz"', () => {
        const r: "baz" = fp.match([class1RString, class2RString, class3RString])(new ClassType3());
        expect(r).toEqual("baz");
      });
      it("should return an instance of ClassType3", () => {
        const r: boolean =
          fp.match([class1RString, class2RString, class3RClass3])(new ClassType3()) instanceof ClassType3;
        expect(r).toBe(true);
      });
      it("should work with a primitive as the matcher", () => {
    ...
    describe("with 4 entries", () => {
      it('should return "foo"', () => {
        const r: "foo" = fp.match([class1RString, class2RString, class3RString, class4RString])(new ClassType1());
        expect(r).toEqual("foo");
      });
      it('should return "bar"', () => {
        const r: "bar" = fp.match([class1RClass1, class2RString, class3RString, class4RString])(new ClassType2());
        expect(r).toEqual("bar");
      });
      it('should return "baz"', () => {
        const r: "baz" = fp.match([class1RClass1, class2RClass2, class3RString, class4RString])(new ClassType3());
        expect(r).toEqual("baz");
      });
      it('should return "bam"', () => {
        const r: "bam" = fp.match([class1RString, class2RString, class3RString, class4RString])(new ClassType4());
        expect(r).toEqual("bam");
      });
      it("should return an instance of ClassType4", () => {
        const r: boolean =
          fp.match([class1RString, class2RString, class3RString, class4RClass4])(new ClassType4()) instanceof
          ClassType4;
        expect(r).toBe(true);
      });
      it("should work with a primitive as the matcher", () => {
    ...
    describe("with 5 entries", () => {
      it('should return "foo"', () => {
        const r: "foo" = fp.match([class1RString, class2RString, class3RString, class4RString, class5RString])(
          new ClassType1()
        );
        expect(r).toEqual("foo");
      });
      it('should return "bar"', () => {
        const r: "bar" = fp.match([class1RClass1, class2RString, class3RString, class4RString, class5RString])(
          new ClassType2()
        );
        expect(r).toEqual("bar");
      });
      it('should return "baz"', () => {
        const r: "baz" = fp.match([class1RClass1, class2RClass2, class3RString, class4RString, class5RString])(
          new ClassType3()
        );
        expect(r).toEqual("baz");
      });
      it('should return "bam"', () => {
        const r: "bam" = fp.match([class1RString, class2RString, class3RString, class4RString, class5RString])(
          new ClassType4()
        );
        expect(r).toEqual("bam");
      });
      it('should return "jam"', () => {
        const r: "jam" = fp.match([class1RString, class2RString, class3RString, class4RString, class5RString])(
          new ClassType5()
        );
      ...
      it("should return an instance of ClassType5", () => {
        const r: boolean =
          fp.match([class1RString, class2RString, class3RString, class4RClass4, class5RClass5])(
            new ClassType5()
          ) instanceof ClassType5;
        expect(r).toBe(true);
      });
      it("should work with a primitive as the matcher", () => {
